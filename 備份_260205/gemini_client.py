...
def list_available_models() -> list[str]:
    try:
        ...
        return ["gemini-2.0-flash-lite", "gemini-2.5-flash", "gemini-1.5-pro", "gemini-1.5-flash"]
...
def build_instructions() -> str:
    ...
    return (
        ...
        "【極重要】年份解析規則：\n"
        "- 民國年轉換：民國年 + 1911 = 西元年\n"
        "- 範例1：「114年11月10日」應轉換為「2025-11-10」（114+1911=2025）\n"
        "- 範例2：「115年1月5日」應轉換為「2026-1-5」（115+1911=2026）\n"
        "- 範例3：「113年12月31日」應轉換為「2024-12-31」（113+1911=2024）\n"
        "- 如果出勤表上顯示的是「民國114年」或「114年」，必須轉換為「2025年」，絕對不能轉換為「2024年」！\n"
        "- 如果出勤表上顯示的是「民國115年」或「115年」，必須轉換為「2026年」，絕對不能轉換為「2025年」或「2024年」！\n"
        "- 必須仔細識別年份數字，確保民國年轉換正確，不可將年份減1或加1。\n"
